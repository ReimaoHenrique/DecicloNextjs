      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center">
            ...
            <span className="ml-2 text-sm text-gray-600">Inteligência Ambiental</span>
          </Link>
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link href="/sobre" className="text-gray-700 hover:text-green-600 transition-colors">
              Sobre Nós
            </Link>
            <Link href="/servicos" className="text-gray-700 hover:text-green-600 transition-colors">
              Serviços
            </Link>
            <Link href="/projetos" className="text-gray-700 hover:text-green-600 transition-colors">
              Projetos
            </Link>
