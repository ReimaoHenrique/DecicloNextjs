    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Simplificando, facilitando e otimizando processos de reciclagem. Gerando mais qualidade de vida, oportunidades de emprego e negócios bem-sucedidos, através da preservação do meio ambiente.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">Maringá, Paraná</p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Deciclo Inteligência Ambiental. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
