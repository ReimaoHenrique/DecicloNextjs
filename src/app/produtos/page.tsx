      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center">
            ...
            >              <Lens lensSize={200} zoomFactor={1.5}>
                <div className="relative w-full h-[400px] bg-white">
                  <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-blue-50 to-blue-100 p-8">
                    <div className="w-48 h-64 bg-blue-500 rounded-md relative overflow-hidden">
                      <div className="absolute inset-x-0 top-0 h-12 bg-white flex items-center justify-center">
                        <span className="font-bold text-blue-600">DECICLO</span>
                      </div>
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-white font-bold text-xl">ÁGUA SANITÁRIA</span>
                      </div>
                      <div className="absolute bottom-0 inset-x-0 h-16 bg-white flex items-center justify-center flex-col">
                        <span className="text-blue-600 font-semibold">1 LITRO</span>
                        <span className="text-blue-600 text-xs">ALTO PODER DE LIMPEZA</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl font-bold mb-4 text-gray-800">Água Sanitária</h2>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-4">
                Nossa água sanitária é produzida com os mais altos padrões de qualidade, 
                garantindo eficiência na limpeza e desinfecção de ambientes. 
                Produto biodegradável e ecologicamente responsável, alinhado com 
                nossa missão de preservação ambiental.
              </p>
            ...
            <div className="mt-8 text-sm text-gray-500">
              <p>
                <span className="font-semibold">Dica de sustentabilidade:</span> Após o uso, 
                lave a embalagem e destine-a para reciclagem, contribuindo para a 
                redução de resíduos plásticos no meio ambiente.
              </p>
            </div>
          </div>
        </div>
